...
from recategorize_from_csv import _rescore_row, _load_lang_config  # noqa: E402
from text_util_langID import pre_filter_line  # noqa: E402
from tests.calibration_fixtures import (  # noqa: E402
    CLEAR, NOISY, TRASH_GARBAGE, NON_TEXT, ROT_FALSE_POSITIVE_GUARDS,
)
...
_HARD_SWEEP = [f for f in TRASH_GARBAGE
               if f[1] is not None and f[2] is not None and f[2] < 0.45 and f[1] > 1000.0]
