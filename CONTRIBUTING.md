...
|:------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------|
| **v0.15.5** | Synthetic data samples replacing restricted archive records (Replaced all real ARUP/ARUB documents in `data_samples/` with 3 fully synthetic demo docs — `CTX000000001`/`2`/`3` — covering clear, mixed-quality, and short/poor OCR cases, Regenerated every derived directory: `ALTO`, `A-PAGE`, `PAGE_ALTO`, `PAGE_TXT`/`_LR`/`_LLM`, `DOC_LINE_CATEG`/`_gpt`, `DOC_LINE_STATS`/`_gpt`, Moved root summary CSVs `test_alto_stats.csv`, `arup_page_stats_SHORT.csv`, `arub_page_stats_SHORT.csv` into `data_samples/` and updated README links, Resolves the licensing issue of shipping restricted records in a public repo. Added structured paradata logging. Clarified license handling and notices to avoid distributing restricted records in the repository.) | Pre-release |
