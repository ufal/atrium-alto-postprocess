# `gh-pages` &mdash; published stub for `atrium-alto-postprocess`

**This branch is not source.** It is an orphan branch holding one static landing
card, published by GitHub Pages at <https://ufal.github.io/atrium-alto-postprocess/>.

* The **code** lives on [`master`](https://github.com/ufal/atrium-alto-postprocess/tree/master).
* The **documentation** lives in the ATRIUM hub site at
  <https://ufal.github.io/atrium-project/workflows/alto-postprocess/>, written from this repository's own
